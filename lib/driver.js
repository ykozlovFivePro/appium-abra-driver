...
/**
 * @implements {ExternalDriver<AbraXCUITestDriverConstraints, FullContext|string>}
 * @extends {BaseDriver<AbraXCUITestDriverConstraints>}
 ...
 */
class AbraXCUITestDriver extends BaseDriver {
  ...
  /**
   *
   * @param {AbraXCUITestDriverOpts} opts
   * @param {boolean} shouldValidateCaps
   */
  constructor(opts = /** @type {AbraXCUITestDriverOpts} */ ({}), shouldValidateCaps = true) {
  ...
  async createSession(w3cCaps1, w3cCaps2, w3cCaps3, driverData) {
    try {
      ...
      return /** @type {[string, import('@appium/types').DriverCaps<AbraXCUITestDriverConstraints>]} */ ([
        sessionId,
        caps,
      ]);
    } catch (e) {
  ...
  async startWda(sessionId, realDevice) {
    ...
    let synchronizationKey = AbraXCUITestDriver.name;
   ...
   *
   * @param {any} caps
   * @returns {caps is import('@appium/types').DriverCaps<AbraXCUITestDriverConstraints>}
   */
   ...
   * @property {Pick<AbraXCUITestDriverOpts, "enforceAppInstall">} enforceAppInstall
   * @property {Pick<AbraXCUITestDriverOpts, "fullReset">} fullReset
   * @property {Pick<AbraXCUITestDriverOpts, "noReset">} noReset
   * @property {Pick<AbraXCUITestDriverOpts, "bundleId">} bundleId
   * @property {Pick<AbraXCUITestDriverOpts, "app">} app
...
/**
 * @typedef {typeof desiredCapConstraints} AbraXCUITestDriverConstraints
 * @typedef {import('@appium/types').DriverOpts<AbraXCUITestDriverConstraints>} AbraXCUITestDriverOpts
