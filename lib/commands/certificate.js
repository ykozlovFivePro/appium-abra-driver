...
export default {
   ...
   * @returns {Promise<{Status: 'Acknowledged'}|'None'>} The "status: acknowledged" response if the profile was removed successfully; otherwise "None" if certificate removal failed.
  ...
  async mobileRemoveCertificate(name) {
    ...
    // @ts-expect-error https://github.com/appium/appium/issues/18507
