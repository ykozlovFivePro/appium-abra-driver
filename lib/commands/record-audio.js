...
/**
 * Defaults for {@linkcode startAudioRecording|mobile: startAudioRecording}
 */
export const AUDIO_RECORD_DEFAULTS = /** @type {const} */ ({
  BITRATE: '128k',
  CODEC: 'aac',
  CHANNELS: 2,
  RATE: 44100,
...
export default {
  ...
  async startAudioRecording(
    audioInput,
    timeLimit = AUDIO_RECORD_DEFAULTS.TIME_LIMIT,
    audioCodec = AUDIO_RECORD_DEFAULTS.CODEC,
    audioBitrate = AUDIO_RECORD_DEFAULTS.BITRATE,
    audioChannels = AUDIO_RECORD_DEFAULTS.CHANNELS,
    audioRate = AUDIO_RECORD_DEFAULTS.RATE,
    forceRestart = AUDIO_RECORD_DEFAULTS.FORCE_RESTART
  ) {
