 ...
 * @property {string} identifier the property is profileID used in {@linkcode AbraXCUITestDriver.enableConditionInducer}
 ...
 * @property {string} identifier the property is conditionID used in {@linkcode AbraXCUITestDriver.enableConditionInducer}
...
export default {
   ...
   * {@linkcode AbraXCUITestDriver.enableConditionInducer}
   ...
   *
   * @param {string} conditionID - Determine which condition IDs are available with the {@linkcode AbraXCUITestDriver.listConditionInducers} command
   * @param {string} profileID - Determine which profile IDs are available with the {@linkcode AbraXCUITestDriver.listConditionInducers} command
  ...
  /**
   * Disable a condition inducer enabled with {@linkcode AbraXCUITestDriver.enableConditionInducer} Usually
