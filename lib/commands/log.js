...
export default {
  ...
  /**
   *
   * @param {AbraXCUITestDriverLogTypes} logType
   * @param {Partial<Record<AbraXCUITestDriverLogTypes,{getLogs(): Promise<any>}>>} [logsContainer]
...
/**
 * @typedef {keyof typeof SUPPORTED_LOG_TYPES} AbraXCUITestDriverLogTypes
 */
