...
const commands = {
   ...
   * @deprecated Use {@linkcode AbraXCUITestDriver.getElementRect} instead
   * @this {AbraXCUITestDriver}
   */
  ...
  /**
   * Alias for {@linkcode AbraXCUITestDriver.getLocation}
   * @param {string|Element} elementId - the element ID
   * @returns {Promise<Position>} The position of the element
   * @deprecated Use {@linkcode AbraXCUITestDriver.getElementRect} instead
   * @this {AbraXCUITestDriver}
   ...
   * @this {AbraXCUITestDriver}
   * @deprecated Use {@linkcode AbraXCUITestDriver.setValue} instead
   */
  async keys(value) {
