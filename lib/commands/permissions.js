 ...
 * @throws {Error} If permission reset fails on the device.
   * @this {XCUITestDriver}
 */
  async mobileResetPermission(opts = /** @type {ResetPermissionOptions} */({})) {
    const {service} = opts;
  if (!service) {
 ...
 * @throws {Error} If permission getting fails or the device is not a Simulator.
   * @this {XCUITestDriver}
 */
  async mobileGetPermission(opts = /** @type {GetPermissionOptions} */({})) {
   ...
   * @this {XCUITestDriver}
   */
  async mobileSetPermissions(opts = /** @type {SetPermissionsOptions} */({})) {
